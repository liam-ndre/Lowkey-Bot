...
module.exports = async (client, interaction) => {
    ...
    const data = await tickets.findOne({ guild: interaction.guildId, message: interaction.message.id }),
        ...
        data.moderators.forEach(v => overwrites.push({ id: v, allow: ["VIEW_CHANNEL"], type: "member" }));
        ...
        channel.send({ content: `${interaction.user.toString()}, stay patient staff will be arriving soon.` });
